/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+armasm+aspnet+bash+basic+batch+c+csharp+cpp+cil+cmake+css-extras+dart+diff+django+gdscript+git+glsl+go+gradle+groovy+hlsl+http+ignore+ini+java+json+json5+jsonp+kotlin+lua+makefile+markdown+markup-templating+nasm+nim+php+powershell+pug+python+cshtml+jsx+tsx+regex+renpy+rest+ruby+rust+sass+scss+solution-file+sql+toml+typescript+typoscript+uri+vbnet+wasm+xml-doc+yaml&plugins=line-numbers+custom-class+show-language+command-line+toolbar */
